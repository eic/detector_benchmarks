...
fig.savefig(f"{plotdir}/diagnostic_input.png", dpi=200, bbox_inches="tight")
plt.close(fig)
#+end_src
...
fig.savefig(f"{plotdir}/EoverP_scan.png", dpi=200, bbox_inches="tight")
plt.close(fig)
#+end_src
...
fig.savefig(f"{plotdir}/EoverP_optimization.png", dpi=200, bbox_inches="tight")
plt.close(fig)
...
fig.savefig(f"{plotdir}/ML_rejection.png", dpi=200, bbox_inches="tight")
plt.close(fig)
