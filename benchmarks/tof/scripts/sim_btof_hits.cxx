...
int sim_btof_hits(const char* fname = "sim_btof_hits.root")
{
  ...
  //hs->Draw("nostack hist");
  c->BuildLegend();
  c->SaveAs("results/tof/sim_btof_hits_nhits.png");
  c->SaveAs("results/tof/sim_btof_hits_nhits.pdf");
  ...
  c->SaveAs("results/tof/sim_btof_hits_Hits_xy.png");
  c->SaveAs("results/tof/sim_btof_hits_Hits_xy.pdf");

  //hAllHits_x_vs_z->DrawCopy("colz");
  hBarrel_x_vs_z->DrawCopy("colz");
  hEndcap_x_vs_z->DrawCopy("colz same");
  c->SaveAs("results/tof/sim_btof_hits_Hits_xz.png");
  c->SaveAs("results/tof/sim_btof_hits_Hits_xz.pdf");

  hBarrel_y_vs_z->DrawCopy("colz");
  hEndcap_y_vs_z->DrawCopy("colz same");
  c->SaveAs("results/tof/sim_btof_hits_Hits_yz.png");
  c->SaveAs("results/tof/sim_btof_hits_Hits_yz.pdf");
    
    
    c = new TCanvas();
    hBarrelTof_time_vs_length->DrawCopy("colz");
    c->SaveAs("results/tof/sim_btof_hits_tofBarrel_tl.png");
    c->SaveAs("results/tof/sim_btof_hits_tofBarrel_tl.pdf");
    c = new TCanvas();
    hBarrelTof_x_vs_y->DrawCopy("colz");
    c->SaveAs("results/tof/sim_btof_hits_tofBarrel_xy.png");
    c->SaveAs("results/tof/sim_btof_hits_tofBarrel_xy.pdf");
    c = new TCanvas();
    hForwardTof_x_vs_y->DrawCopy("colz");
    c->SaveAs("results/tof/sim_btof_hits_tofForward_xy.png");
    c->SaveAs("results/tof/sim_btof_hits_tofForward_xy.pdf");
    c = new TCanvas();
    hBackwardTof_x_vs_y->DrawCopy("colz");
    c->SaveAs("results/tof/sim_btof_hits_tofBackward_xy.png");
    c->SaveAs("results/tof/sim_btof_hits_tofBackward_xy.pdf");
