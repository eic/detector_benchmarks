...
int sim_etof_hits(const char* fname = "sim_etof_hits.root")
{
  ...
  auto hVertexEndcap_Ntheta = df0.Histo1D({"hVertexEndcap_Ntheta", "; #theta [deg.]",   20, 0, 180 }, "theta0");
    ...
    auto hForwardTof_Ntheta = df0.Histo1D({"hForwardTof_Ntheta", "; #theta [deg.]",   20, 0, 180 }, "theta0");
    auto hBackwardTof_Ntheta = df0.Histo1D({"hBackwardTof_Ntheta", "; #theta [deg.]",   20, 0, 180 }, "theta0");
  ...
  c->BuildLegend();
  c->SaveAs("results/tof/sim_etof_hits_n_hits_vs_theta.png");
  c->SaveAs("results/tof/sim_etof_hits_n_hits_vs_theta.pdf");
  ...
  hs->Draw("nostack hist");
  c->BuildLegend();
  c->SaveAs("results/tof/sim_etof_hits_theta.png");
  c->SaveAs("results/tof/sim_etof_hits_theta.pdf");
  ...
  //hs->Draw("nostack hist");
  c->BuildLegend();
  c->SaveAs("results/tof/sim_etof_hits_nhits.png");
  c->SaveAs("results/tof/sim_etof_hits_nhits.pdf");
  ...
  c->SaveAs("results/tof/sim_etof_hits_Hits_xy.png");
  c->SaveAs("results/tof/sim_etof_hits_Hits_xy.pdf");

  //hAllHits_x_vs_z->DrawCopy("colz");
  hBarrel_x_vs_z->DrawCopy("colz");
  hEndcap_x_vs_z->DrawCopy("colz same");
  c->SaveAs("results/tof/sim_etof_hits_Hits_xz.png");
  c->SaveAs("results/tof/sim_etof_hits_Hits_xz.pdf");

  hBarrel_y_vs_z->DrawCopy("colz");
  hEndcap_y_vs_z->DrawCopy("colz same");
  c->SaveAs("results/tof/sim_etof_hits_Hits_yz.png");
  c->SaveAs("results/tof/sim_etof_hits_Hits_yz.pdf");
    
    
    c = new TCanvas();
    hBarrelTof_time_vs_length->DrawCopy("colz");
    c->SaveAs("results/tof/sim_etof_hits_tofBarrel_tl.png");
    c->SaveAs("results/tof/sim_etof_hits_tofBarrel_tl.pdf");
    c = new TCanvas();
    hBarrelTof_x_vs_y->DrawCopy("colz");
    c->SaveAs("results/tof/sim_etof_hits_tofBarrel_xy.png");
    c->SaveAs("results/tof/sim_etof_hits_tofBarrel_xy.pdf");
    c = new TCanvas();
    hForwardTof_x_vs_y->DrawCopy("colz");
    c->SaveAs("results/tof/sim_etof_hits_tofForward_xy.png");
    c->SaveAs("results/tof/sim_etof_hits_tofForward_xy.pdf");
    c = new TCanvas();
    hBackwardTof_x_vs_y->DrawCopy("colz");
    c->SaveAs("results/tof/sim_etof_hits_tofBackward_xy.png");
    c->SaveAs("results/tof/sim_etof_hits_tofBackward_xy.pdf");
