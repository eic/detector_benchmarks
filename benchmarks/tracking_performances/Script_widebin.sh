...
npsim --compactFile ../epic/install/share/epic/epic_craterlake_tracking_only.xml --outputConfig.useRNTuple true --outputFile sim${mom_array[i]}.edm4hep.rnt.root --numberOfEvents $nevents --enableGun --gun.thetaMin 3*deg --gun.thetaMax 177*deg --gun.distribution eta --gun.particle pi- --gun.momentumMin ${mom_array[i]}*GeV --gun.momentumMax ${mom_array[i]}*GeV --gun.multiplicity 1 --random.seed 100000
done
...
eicrecon \
 ...
 sim${mom_array[i]}.edm4hep.rnt.root
done
